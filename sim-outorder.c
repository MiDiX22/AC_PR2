...
/* yags predictor config (<l1size> <l2size> <hist_size> <xor>) */
...
"  Predictor `comb' combines a bimodal and a 2-level predictor.\n"
  ...
  opt_reg_string(odb, "-bpred",
		 "branch predictor type {nottaken|taken|perfect|bimod|2lev|comb|yags}",
...
"      -cache:dl1 ul1:256:32:1:l -cache:dl2 ul2:1024:64:2:l\n"
  ...
  opt_reg_string(odb, "-tlb:dtlb",
		 "data TLB config, i.e., {<config>|none}",
		 &dtlb_opt, "dtlb:32:4096:4F:l", /* print */TRUE, NULL);
		  ...
		  int argc, char **argv)        /* command line arguments */
{
  ...
  if (!mystricmp(pred_type, "perfect"))
    ...
    {
      /* yags predictor, bpred_create() checks args */
      if (yags_nelt != 4)
	...
	fatal("bad btb config (<num_sets> <associativity>)");
      ...
      pred = bpred_create(BPredYags,
			  /* bimod table size */0,
			  /* yags l1 size */yags_config[0],
			  /* yags l2 size */yags_config[1],
			  /* meta table size */0,
